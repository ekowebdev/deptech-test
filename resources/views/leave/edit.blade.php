                  ...
                  <div class="card-body">
                      <form action="{{ route('leave.update', $data->id) }}" method="POST">
                              ...
                              <div class="col-md-6">
                                  <select name="employee_id" id="employee_id" class="form-control">
                                    ...
                                    @foreach($employee as $emp)
                                        <option value="{{ $emp->id }}" {{ ($emp->id == $data->employee_id) ? "selected" : "" }}>{{ $emp->first_name }} {{ $emp->last_name }}</option>
                                    @endforeach
                                  </select>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea name="reason" id="reason" class="form-control" cols="50">{{ $data->reason }}</textarea>
