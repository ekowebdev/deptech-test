                  ...
                  <div class="card-body">
                      <form action="{{ route('employee.store') }}" method="POST">
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                  <input type="text" id="first_name" class="form-control" name="first_name" value="{{ old('first_name') }}" autofocus>
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                  <input type="phone_number" id="phone_number" class="form-control" name="phone_number">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea name="address" id="address" class="form-control" cols="50"></textarea>
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="gender" id="men" value="men" {{ old('gender') == 'men' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="men">
                                        Laki-laki
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input" type="radio" name="gender" id="women" value="women" {{ old('gender') == 'women' ? 'checked' : '' }}>
